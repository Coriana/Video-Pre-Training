...
from agent import ENV_KWARGS, resize_image, AGENT_RESOLUTION
        ...
        while(cap.isOpened()):
            ...
            if Num_frames != 128:
                ...
                for i in range(Num_frames):
                    ...
                    if i > 96: # untrusted as not enough future data is known to predict the actions, don't worry, next batch will have these as the first 32 trusted predictions.
                        continue
                    ...
                    cv2.putText(
                        frame,
                        f"Adjusted Camera: " + str(pix_pitch) + str(pix_yaw),
                        (250, 25 + y * 18),
                        cv2.FONT_HERSHEY_SIMPLEX,
                        1,
                        (255, 170, 0),
